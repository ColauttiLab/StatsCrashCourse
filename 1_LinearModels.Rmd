...
**NOTE**: The $t$-statistic in the summary table corresponds to the $F$ statistic for the model with the parameter removed. For example, compare:
...
with the $t$-test in te full model
